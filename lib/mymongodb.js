...
(function (mymongodb) {
	...
	mymongodb.deleteMailMessage = function(fromname, toname, mid, signature, ipaddress, callback){
	...
	mymongodb.getMailMessageAttachmentPassword = function(fromname, toname, mid, hash, nlen, callback){
		callback = callback || function() {};
		var _query = {
			'_key':'msg:' + mid,
			'from':fromname,
	...
	mymongodb.getMailMessageAttachmentInfo = function(fromname, toname, mid, callback){
		callback = callback || function() {};
		var _query = {
			'_key':'msg:' + mid,
			'from':fromname,
	...
	mymongodb.updateMailMessageAttachment = function(name, mid, curlen, nFinish, encrypt, dlhash, dllen, callback){
		callback = callback || function() {};
		var _data = {
			'upcurlen': curlen
		};
	...
	mymongodb.getMailMessageAttachmentAuth = function(name, mid, callback){
		callback = callback || function() {};
	...
	mymongodb.createNewMailMessage = function(fromname, toname, msglen, hash, upsign, ipaddress, callback){
		var _now = Date.now();
		var data = {
			'uphash':hash,
			'upmsglen':msglen,
